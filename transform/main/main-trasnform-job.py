...
keyword_dict = {
  ...
  "performance": [
    ...
    "전기","드리프트","발열","냉각","수온","파워","브렘보","제로백","크루즈컨트롤","내구성",
  ...
  "price": [
    ...
    "고정","변동","무이자","포인트","캐시백","보조금","전기","수소차","폐차","리세일",
  ...
  "fault": [
    ...
    "진동","떨림","과열","시동","불량","급발진","전기","전자","배터리","방전",
...
if __name__ == "__main__":
    ...
    sentence_processed.write.mode("overwrite").parquet(f"{mode}{bucket}/{output_dir}/keyword_category")
