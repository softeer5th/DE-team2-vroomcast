...
with DAG(
    ...
    push_task = create_push_to_xcom_task(dag, "synchronize", {
        "prev_batch_info": info[0],
        "current_batch_info": info[1]
    })
    ...
    push_task >> execute_emr_task >> check_emr_termination_task >> terminate_emr_cluster_task
