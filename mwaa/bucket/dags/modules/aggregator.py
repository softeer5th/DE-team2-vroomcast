           ...
           for community in COMMUNITIES:
               ...
               try:
                   ...
                   if extract_result is None:
                       ...
                       statistics[car_id][community]["error"] = "No data returned from task"
                       continue
                   ...
                   if info["success"] == False:
                       ...
                       statistics[car_id][community]["attempted_posts_count"] = info.get("attempted_posts_count")
                       statistics[car_id][community]["extracted_posts_count"] = info.get("extracted_posts_count")

                   logger.info(f"Aggregated {task_id}: {statistics[car_id][community]}")

               except Exception as e:
                   logger.error(
                       f"Error aggregating {task_id}: {str(e)}", 
                       exc_info=True
                   )
